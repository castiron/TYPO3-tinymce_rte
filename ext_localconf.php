<?php
//use \TYPO3\CMS\Core\Utility\\TYPO3\CMS\Core\Utility\ExtensionManagementUtility;
if (!defined ("TYPO3_MODE")) 	die ("Access denied.");

// override TS_links_rte( ), TS_images_db()
$TYPO3_CONF_VARS['BE']['XCLASS']['t3lib/class.t3lib_parsehtml_proc.php'] = \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath($_EXTKEY).'class.ux_t3lib_parsehtml_proc.php';
...
$TYPO3_CONF_VARS['BE']['XCLASS']['ext/setup/mod/index.php'] = \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath($_EXTKEY).'ux_index.php';
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPageTSConfig('<INCLUDE_TYPOSCRIPT: source="FILE:EXT:' . $_EXTKEY . '/static/pageTSConfig.ts">');
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPageTSConfig('<INCLUDE_TYPOSCRIPT: source="FILE:' . $extConf['pageLoadConfigFile'] . '">');

if ( $extConf['loadConfig'] !== '' ) {
	\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPageTSConfig('<INCLUDE_TYPOSCRIPT: source="FILE:' . $extConf['loadConfig'] . '">');
}

// load default SetupTS config from static
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTypoScript($_EXTKEY,'setup','<INCLUDE_TYPOSCRIPT: source="FILE:EXT:' . $_EXTKEY . '/static/setupTSConfig.ts">',43);
